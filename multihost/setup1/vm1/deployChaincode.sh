...
#     export CORE_PEER_MSPCONFIGPATH=${PWD}/../../artifacts/channel/crypto-config/peerOrganizations/org2.subskribo.be/users/Admin@org2.subskribo.be/msp
...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o 10.1.0.13:7050 \
        --ordererTLSHostnameOverride orderer0.subskribo.be --tls \
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer0.subskribo.be \
